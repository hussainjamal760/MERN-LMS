...
const CourseContentMedia = ({ data, id, activeVideo, setActiveVideo, user, refetch }: Props) => {
    ...
    return (
        <div className="w-[95%] 800px:w-[86%] py-4 m-auto">
            ...
            <br />
            <div className="w-full p-4 flex items-center justify-between bg-slate-50 dark:bg-slate-700 bg-opacity-20 backdrop-blur shadow-[bg-slate-700] rounded shadow-inner">
                ...
                <>
                    <div className="flex w-full">
                        ...
                        <textarea
                            ...
                            className="outline-none bg-transparent ml-3 border dark:border-[#ffffff57] border-gray-400 800px:w-full p-2 rounded w-[90%] 800px:text-[18px] font-Poppins text-black dark:text-white"
                        ></textarea>
                    </div>
                                ...
                                <div className="flex w-full">
                                    ...
                                    <div className="w-full">
                                        ...
                                        <textarea
                                            ...
                                            className="outline-none bg-transparent 800px:ml-3 border dark:border-[#ffffff57] border-gray-400 800px:w-full p-2 rounded w-[90%] 800px:text-[18px] font-Poppins text-black dark:text-white"
                                        ></textarea>
                                    </div>
                                </div>
                                <div className="w-full flex justify-end">
                            ...
                            {(courseData?.course?.reviews && [...courseData.course.reviews].reverse())?.map((item: any, index: number) => (
                                <div className="w-full my-5" key={index}>
                                    <div className="w-full flex">
                                        <div>
                                            <Image
                                                src={item.user.avatar ? item.user.avatar.url : "../../assets/avatar.png"}
                                                width={50}
                                                height={50}
                                                alt=""
                                                className="w-[50px] h-[50px] rounded-full object-cover"
                                        ...
                                        <div className="ml-2">
                                            <h1 className="text-[18px] font-[600] text-black dark:text-white">{item.user.name}</h1>
                                    ...
                                    {/* Replies to reviews can be added here if admin */}
                                </div>
                            ))}
                        </div>
                    </>
                        ...
                        <>
                            <div className="w-full flex relative dark:text-white text-black">
                                <input
                                    ...
                                    className={`block 800px:ml-12 mt-2 outline-none bg-transparent border-b border-[#00000027] dark:border-[#fff] p-[5px] w-[95%] ${answer === "" || (answerCreationLoading && 'cursor-not-allowed')}`}
                                />
                                <button
                                    type="submit"
